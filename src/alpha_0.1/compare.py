...
def compare_multiple_results(file_label_map: Dict[str, str], fig_dir: str = "Comparison_figures") -> None:
    full_fig_dir = os.path.join(BASE_DIR, fig_dir, "alpha_0.1")
...
if __name__ == "__main__":
    file_label_map = {
        "FedAvg_alpha_01.json": "FedAvg",
        "FedProx_alpha_01_mu_01.json": "FedProx(μ=0.1)",
        "SCAFFOLD_alpha_01.json": "SCAFFOLD"
    }
