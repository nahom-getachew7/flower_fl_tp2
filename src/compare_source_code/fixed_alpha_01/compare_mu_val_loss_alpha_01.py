...
def compare_fedprox_results(file_label_map: Dict[str, str], fig_dir: str = "./Compare/mu/alpha_01") -> None:
    ...
    plt.title("FedProx Validation Loss Comparison (α=0.1)")
    plt.xlabel("Round")
    plt.ylabel("Loss")
    plt.legend()
    plt.grid(True)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fig_dir, "fedprox_mu_comparison_alpha_01.png"))
    plt.close()


if __name__ == "__main__":
    file_label_map = {
        "result_alpha_01_mu_01.json": "μ=0.1",
        "result_alpha_01_mu_05.json": "μ=0.5",
        "result_alpha_01_mu_1.json": "μ=1.0"
    }
