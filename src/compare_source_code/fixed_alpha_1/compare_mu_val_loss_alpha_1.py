...
def compare_fedprox_results(file_label_map: Dict[str, str], fig_dir: str = "./Compare/mu/alpha_1") -> None:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fig_dir, "fedprox_mu_comparison_alpha_1.png"))
    plt.close()
...
if __name__ == "__main__":
    file_label_map = {
        ...
        "result_alpha_1_mu_1.json": "μ=1.0"
    }
